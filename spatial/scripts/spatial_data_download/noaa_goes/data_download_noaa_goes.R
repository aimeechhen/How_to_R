...
# data source: https://noaa-goes18.s3.amazonaws.com/index.html
...
goes_bucket <- get_bucket("noaa-goes18", prefix = "ABI-L2-FDCF/2023/", max = Inf)
goes_bucket <- get_bucket("noaa-goes18", prefix = "ABI-L2-FDCM/2023/", max = Inf)
