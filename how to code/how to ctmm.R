...
as.telemetry() 
# When converting into as.telemetry() object, ctmm will create a dataframe (or list if there is tracking data for multiple individuals) with the following columns
names(test)
